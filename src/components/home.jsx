...
import back from "../assets/website.png";
import pack from "../assets/right.png";
    ...
    <>
      <div className="relative min-h-screen flex flex-col justify-between">
        ...
        <div className="absolute">
          <img src={back} className="object-cover w-full h-full" alt="Background" />
        </div>
        ...
        <div className="relative -mt-110 mx-20">
          <button className="py-2 px-8 font-[oswald] text-white text-[25px] hover:scale-110 hover:rotate-2 duration-300 font-extrabold rounded-full drop-shadow-lg bg-[#7dd44e]">
            ORDER NOW
          </button>
        </div>
